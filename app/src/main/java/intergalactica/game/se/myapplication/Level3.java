...
public class Level3 extends Level {
    ...
    public Level3(Context context, ActorLoader actorLoader) {
    ...
    public void createLevel() {

        {
            ...
            createBackground(attributes, shadersBackground, attrsUnifs, ActorFactory.DJUNGLE_BACKGROUND_IDX, ActorFactory.BACKGROUND_ACTOR, 0);

            mediaPlayer = MediaPlayer.create(context, R.raw.jungleborneo_02);
            mediaPlayer.start();
    ...
    public void createObstacle3() {
        ...
        for (ActorHolder actorHolder: boogerPoolList) {
            ...
            if ( actorHolder.isAvailable()) {
                ...
                ((LifeComponent)actor.getComponent(ComponentFactory.LIFECOMPONENT)).setCurrentHealth(30);
                ((AnimationComponent)actor.getComponent(ComponentFactory.ANIMATIONCOMPONENT)).setListID(0);
                ((MotionComponent)actor.getComponent(ComponentFactory.MOTIONCOMPONENT)).set_velocityX(0.05f);
